            ...
            newArticle.innerHTML =
             `<article class="w-full p-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)] ">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <a href="/admin/${item.id}" class="px-3 py-1 font-sourceSans font-semibold text-white bg-blue-700 rounded-2xl active:bg-blue-600">view <i class="fa-regular fa-eye text-sm"></i></a>
                </div>
            </article>`;
